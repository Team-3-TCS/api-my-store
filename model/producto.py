...
@app.route('/compra/<id_producto>',methods=['GET'])
def get_producto_id(id_producto):
    producto=Producto.query.get(id_producto)
    return producto_schema.jsonify(producto)

@app.route('/compra/<nombre>',methods=['GET'])
...
@app.route('/compra/<id_producto>',methods=['PUT'])
def update_producto(id_producto):
    compra=Compra.query.get(id_producto)
    id_categoria=request.json['id_categoria']
    id_vendedor=request.json['id_vendedor']
    nombre=request.json['nombre']
    descripcion=request.json['descripcion']
    ...
    fecha_adicion=request.json['fecha_adicion']
    fecha_modificacion=request.json['fecha_modificacion']
    compra.id_categoria=id_categoria
    ...
    compra.stock=stock
    compra.estado_activacion=estado_activacion
    compra.fecha_adicion=fecha_adicion
    compra.fecha_modificacion=fecha_modificacion
    db.session.commit()
    return producto_schema.jsonify(producto)
...
#actualizar datos es con el method PUT
@app.route('/compra/<nombre>',methods=['PUT'])
def update_producto(id_producto):
    compra=Compra.query.get(nombre)
...
@app.route('/compra/<id_producto>',methods=['DELETE'])
